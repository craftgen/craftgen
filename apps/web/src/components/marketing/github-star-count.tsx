  ...
  return (
    <div className="flex">
      <Link
        ...
        className=" animate-shimmer caption-s  border-slate-7 bg-slate-3 text-slate-12 hover:border-slate-8 hover:bg-slate-4 flex items-center gap-1 rounded-l-[4px] border bg-[linear-gradient(110deg,#fff,45%,#0284c720,55%,#fff)] bg-[length:200%_100%] px-2 py-[2px] font-medium dark:bg-[linear-gradient(110deg,#000103,45%,#1e2631,55%,#000103)]"
      >
      ...
      >
        <span className="caption-s text-slate-12 group-hover:text-primary font-medium">
