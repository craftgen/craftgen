...
Empower your workforce with Copilot for Microsoft 365 by automating routine tasks and providing intelligent suggestions, but it is not an AI agent as it works alongside humans rather than autonomously.
...
### What is the difference between AI agent and rational agent?
...
### What is the difference between AI model and AI agent?
