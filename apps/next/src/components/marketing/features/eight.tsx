...
export function FeatureCard8() {
  ...
  return (
    <div className="relative h-full w-full max-w-[32rem] transform-gpu rounded-lg border  [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)]  dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset] md:max-h-[500px]">
      <motion.div
          ...
          <div className="relative flex flex-col items-center justify-center gap-y-2 px-10 py-20">
            ...
            >
              ...
              <div className="w-[calc(100%-3rem)]">
                <h3 className="text-base font-semibold">Editor: Mary</h3>
                <p className="text-sm text-neutral-500 dark:text-neutral-400">
                  I think the product description can be improved
                </p>
              </div>
            </motion.div>
            <motion.div
            ...
            >
              ...
              <div className="w-[calc(100%-3rem)]">
                <h3 className="text-base font-semibold">AI Joshua</h3>
                <p className="text-sm text-neutral-500 dark:text-neutral-400">
                  On it ✅
                </p>
              </div>
