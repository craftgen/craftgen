...
ALTER TABLE "workflow_execution" RENAME COLUMN "entry_node_id" TO "entry_context_id";--> statement-breakpoint
ALTER TABLE "workflow_execution" DROP CONSTRAINT "workflow_execution_entry_node_id_workflow_node_id_fk";
--> statement-breakpoint
ALTER TABLE "workflow_execution" ALTER COLUMN "entry_context_id" DROP NOT NULL;--> statement-breakpoint
DO $$ BEGIN
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "workflow_execution_event" ADD CONSTRAINT "workflow_execution_event_source_node_id_node_execution_data_id_fk" FOREIGN KEY ("source_node_id") REFERENCES "node_execution_data"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "workflow_execution_event" ADD CONSTRAINT "workflow_execution_event_target_node_id_node_execution_data_id_fk" FOREIGN KEY ("target_node_id") REFERENCES "node_execution_data"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
