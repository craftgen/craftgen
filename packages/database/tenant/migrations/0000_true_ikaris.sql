...
CREATE UNIQUE INDEX `workflow_version_workflow_id_version_unique` ON `workflow_version` (`workflow_id`,`version`);--> statement-breakpoint
CREATE UNIQUE INDEX `variable_key_unique` ON `variable` (`key`);